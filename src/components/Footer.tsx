...
import { GithubLogo, LinkedinLogo, Heart, InstagramLogo } from 'phosphor-react';
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/shivaputrakadla_?igsh=MTQ5ZzMzZHVzbTlqdg==" className="w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
        ...
        <div className="border-t border-border/30 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-center md:text-left">
            © 2025 Shivaputra kadla. All rights reserved.
          </p>
