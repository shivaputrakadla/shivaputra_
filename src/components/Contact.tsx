          ...
          <div ref={infoRef} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">shivaputrakadla@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Kalaburi, karnataka</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.linkedin.com/in/shivaputra-kadla-6a4b46203?utm_source=share_via&utm_content=profile&utm_medium=member_android" className="w-12 h-12 bg-gradient-secondary rounded-lg flex items-center justify-center hover:shadow-glow-secondary transition-all duration-300 hover:scale-110">
                  <LinkedinLogo size={20} className="text-secondary-foreground" />
                </a>
                <a href="https://www.instagram.com/shivaputrakadla_?igsh=MTQ5ZzMzZHVzbTlqdg==" className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
